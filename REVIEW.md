...
| 📄 | **[Whitepaper (PDF)](docs/whitepaper-konvergenz.pdf)** · [Markdown](docs/whitepaper-konvergenz.md) | Die Lucke-Antwort mit Tiefe, deutsch + engl. Abstract. |
| 💬 | **[GEGENENTWURF.md](GEGENENTWURF.md)** | Die kurze, postbare Position. |

Die **Lucke-Antwort als LinkedIn-Kommentar** (Sie-Form, ~4 Absätze) liegt im Session-Verlauf —
...
|---|---|---|
| [cong-driven-development](https://github.com/Koschnag/cong-driven-development) | `1ebb767` | [Actions](https://github.com/Koschnag/cong-driven-development/actions) |
...
- [ ] **Außendarstellung** — Lucke-Antwort posten (Sie-Form) + Whitepaper/Repos verlinken. *Dein Akt.*

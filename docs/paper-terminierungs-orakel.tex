...
$36/36$ grünen Tests (autoritativer Runner-Count @\,\texttt{main}); der reflexive
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.50\textwidth} c p{0.32\textwidth}@{}}
    ...
    CDD-Selbst-Gate: $36/36$ Tests, $62/66$ \texttt{Aligned} & \AB{A} & \texttt{cong-driven-development}\,@\,\texttt{main} (Runner) \\

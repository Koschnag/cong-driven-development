...
in \texttt{cong-driven-development}~\cite{cdd2026}, ausgewertet am Commit \texttt{v0.6.0}. Das tragende Artefakt
...
$37/37$ grünen Tests (autoritativer Runner-Count @\,\texttt{v0.6.0}); der reflexive
...
maschinell prüfbar --- sie ist eine A-Aussage, verankert im Code @\,\texttt{v0.6.0}.
...
ist im Repository \texttt{cong-driven-development}\,@\,\texttt{v0.6.0} als typisierter
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{0.50\textwidth} c p{0.32\textwidth}@{}}
    ...
    CDD-Selbst-Gate: $37/37$ Tests, $62/66$ \texttt{Aligned} & \AB{A} & \texttt{cong-driven-development}\,@\,\texttt{v0.6.0} (Runner) \\
    ...
    Allowlist-Trennung Generator~$\perp$~Prüf-Orakel & \AB{A} & Code\,@\,\texttt{v0.6.0} \\
...
einem reflexiven Selbst-Gate (\texttt{cong-driven-development}\,@\,\texttt{v0.6.0},
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    \midrule
    \texttt{Koschnag/cong-driven-development} & \texttt{v0.6.0} & Methode/IDE, reflexives Selbst-Gate \\
...
\newblock Software-Repository, \texttt{github.com/Koschnag/cong-driven-development}\,@\,\texttt{v0.6.0}, 2026.

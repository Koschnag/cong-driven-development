...
\begin{lstlisting}[language=lean,caption={Kern-Theorem in \texttt{proofs/Werterhaltung.lean}\,@\,\texttt{72b1284} (verbatim; Definitionen und das Lemma \texttt{werterhaltung\_einzel} im Repo)},label={lst:werterhaltung}]
